...
if clientID != -1:
    ...
    for j in even_list:
        ...
        for a in range(n_actions):
            ...
            blocks_in_game = []
            if a > 1:
                new = shapeslist[order[a-2]].get_position_basic(shapeslist[order[a-2]].getPosition(), False, withoutAll[order[a - 2]])
