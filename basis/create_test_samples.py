        ...
        for j in range(n_actions):
            ...
            for m in range(n_agents):
                ...
                if in_game[b] == 1:
                    ...
                    b1 = c1
                    b2 = c2
                d1 = point_distance([c1, c2], [a1, a2])
                d2 = point_distance([c1, c2], [b1, b2])
                # current position
                if in_game[m] == 0:
                    position[m] = [1, 0, 0, 1, 0, 0]
                elif same_as(c3, 0):
                    position[m] = [0, c1 - a1, c2 - a2, 0, c1 - b1, c2 - b2]
                elif same_as(size[a][0] + size[b][0], c3):
                    if old_position[a][2] > old_position[b][2]:
                    ...
                    if same_as(size[a][0], c3) and same_as(old_position[a][2], 0):
                        position[m] = [1, c1 - a1, c2 - a2, 0, c1 - b1, c2 - b2]
                    else:
                        position[m] = [0, c1 - a1, c2 - a2, 1, c1 - b1, c2 - b2]
                else:
                    if same_as(size[b][0], c3) and same_as(old_position[b][2], 0):
                        position[m] = [0, c1 - a1, c2 - a2, 1, c1 - b1, c2 - b2]
                    else:
                        position[m] = [1, c1 - a1, c2 - a2, 0, c1 - b1, c2 - b2]
                ...
                if in_game_next[m] == 0:
                    ...
                    if old_next_position[a][2] > old_next_position[b][2]:
                        next_position[m] = [1, c1 - a1, c2 - a2, 0, c1 - b1, c2 - b2]
                    else:
                        next_position[m] = [0, c1 - a1, c2 - a2, 1, c1 - b1, c2 - b2]
                elif in_game_next[a] == 0:
                    next_position[m] = [0, c1 - a1, c2 - a2, 1, c1 - b1, c2 - b2]
                elif in_game_next[b] == 0:
                    next_position[m] = [1, c1 - a1, c2 - a2, 0, c1 - b1, c2 - b2]
                elif d1 < d2:
                    if same_as(size[a][0], c3) and same_as(old_next_position[a][2], 0):
                        next_position[m] = [1, c1 - a1, c2 - a2, 0, c1 - b1, c2 - b2]
                    else:
                        next_position[m] = [0, c1 - a1, c2 - a2, 1, c1 - b1, c2 - b2]
                else:
                    if same_as(size[b][0], c3) and same_as(old_next_position[b][2], 0):
                        next_position[m] = [0, c1 - a1, c2 - a2, 1, c1 - b1, c2 - b2]
                    else:
                        next_position[m] = [1, c1 - a1, c2 - a2, 0, c1 - b1, c2 - b2]
            ...
            elif same_as(size[reference_block][0] + size[other_block][0], old_next_position[block_to_be_moved][2]):
            ...
            elif old_next_position[block_to_be_moved][2] >= 0.1:
            ...
            elif same_as(old_next_position[block_to_be_moved][2], 0):
...
with open("test_states_target.json", 'w') as f:
