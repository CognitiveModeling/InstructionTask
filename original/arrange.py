...
if clientID!=-1:
    ...
    #cylinder1.turnOriginalWayUp()
    #cylinder2.turnOriginalWayUp()
    #cylinder3.turnOriginalWayUp()

    #cylinder1.setAtopVariable(cuboid3, 0, -0.1)

    cylinder3.setAtopCenter(cuboid2)
