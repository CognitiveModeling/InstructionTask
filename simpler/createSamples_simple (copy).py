                        ...
                        if m+1 == 3:
                            ...
                            if math.isnan(data[j][l][m + 1][0]):
                                ...
                                if data[j][l][m+2][0] == -1:
                                    ...
                                    helper.append(-1)
                                    helper.append(-1)
                                elif len(data[j - 1][l]) == 6:
                                    helper.append(data[j - 1][l][m + 2][0])
                                    helper.append(data[j - 1][l][m + 2][1])
                                    helper.append(data[j - 1][l][m + 2][2])
                                    helper.append(data[j - 1][l][m + 2][3])
                                else:
                                    helper.append(0)
                                    helper.append(0)
                                    helper.append(-1)
            ...
            if len(data[n_actions][l]) == 6:
                ...
                for m in range(4):
                    if m+1 == 3:
                        ...
                        helper.append(data[n_actions][l][m + 1][0])
                        if len(data[j - 1][l]) == 6:
                            helper.append(data[n_actions -1][l][m + 2][0])
                            helper.append(data[n_actions -1][l][m + 2][1])
                            helper.append(data[n_actions -1][l][m + 2][2])
                            helper.append(data[n_actions -1][l][m + 2][3])
                        else:
                            helper.append(0)
                            helper.append(0)
                            helper.append(-1)
